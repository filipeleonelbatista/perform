...
const data = {
  subTitle: 'Seu negócio agora digital',
  title: 'Não espere mais tempo para migrar para o digital',
  features: [
    {
      id: 1,
      imgSrc: Briefcase,
      altText: 'Seus Clientes',
      title: 'Seus Clientes',
      text:
        'Apareça onde seus clientes estão, facebook, instagram, pesquisas do google. Faça sua presença na internet mais visível gente.',
    },
    {
      id: 2,
      imgSrc: Secure,
      altText: 'Conversão melhorada',
      title: 'Conversão melhorada',
      text:
        'Facilite sua conversão de clientes com os serviços exclusivos para seu negócio.',
    },
  ],
};
