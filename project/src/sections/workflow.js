...
const data = [
  {
    ...
    text:
      'A consultoria serve para analisar cada cliente e onde tem o potencial de melhorar sua interação.',
  },
  {
    id: 2,
    title: 'Verifique os planos apresentados para seu negócio',
    text:
      'A consultoria apresentará soluções rápidas para seu negócio se transformar, então não perca tempo.',
  },
  {
    id: 3,
    title: 'Aplicando as soluções',
    text:
      'Aplicar as tecnologias requer esforço e tempo, isso deixa com a gente.',
  },
  {
    id: 4,
