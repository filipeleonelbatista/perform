...
import BannerContato from 'sections/banner-contato';
import FeaturMktDigital from 'sections/feature-mkt-digital';
  ...
  return (
    <div onMouseLeave={openModal}>
      ...
      <ThemeProvider theme={theme}>
        <StickyProvider>
          <Layout>
            <SEO title="Marketing Digital | Agência Perform - Impulsionando resultados digitais" 
                 description="Deixamos sua empresa nas primeiras posições no GOOGLE. Atraia a atenção dos seus clientes nas redes sociais e aumente seu alcance na sua região"/>
            <BannerContato />
            <FeaturMktDigital />
            <CallToAction title="Equipe especializada pronta para ajudar sua empresa a crescer"
                          subtitle="" />
            <ContactForm location="Landing page Marketing digital" />
          </Layout>
        </StickyProvider>
      </ThemeProvider>
      <Floating location="Landing page Marketing digital" />
    </div>
  );
}
