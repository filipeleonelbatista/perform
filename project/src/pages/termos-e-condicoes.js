  ...
  return (
    <div onMouseLeave={openModal}>
      ...
      <ThemeProvider theme={theme}>
        <StickyProvider>
          <Layout>
            <SEO title="Termos e Condições | Agência Perform | Impulsionando resultados digitais" />            
            <CallToAction title="Termos e condições"
                subtitle="" />
            <ContactForm location="Página Termos e Condições" />
          </Layout>
        </StickyProvider>
      </ThemeProvider>
      <Floating location="Página Termos e Condições" />
    </div>
  );
}
